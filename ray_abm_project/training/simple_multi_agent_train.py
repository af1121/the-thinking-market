...
def simple_multi_agent_train():
    """Simple multi-agent training that should work with current Ray version"""
    ...
    # Configure PPO with new API stack disabled for compatibility
    config = (
        PPOConfig()
        .api_stack(
    ...
    for iteration in range(10):
        print(f"🔄 Training iteration {iteration + 1}/10...")
    ...
    # Save results
    save_results(results, "simple_multi_agent")
...
if __name__ == "__main__":
    print("🎯 Simple Multi-Agent Training")
    print("=" * 50)
    
    results = simple_multi_agent_train()
